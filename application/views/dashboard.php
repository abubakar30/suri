...
<div class="wrapper">
		...
		<div class="container-fluid">
			<form action="<?php echo base_url('transaction/submit') ?>" method="POST">
				<div class="row" style="min-height: 150px; position: relative;">
					...
					<button type="submit" class="btn btn-primary" style="position: absolute; bottom: 10px; right: 10px;">Search</button>
				</div>
			</form>
			...
			<div class="row">
				...
				<a href="<?php echo base_url('deposit') ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
				</div>
			</div>
			<div class="col-lg-6 col-6">
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2025 <a href="https://suri.com">SURI</a>.</strong>
    All rights reserved.
